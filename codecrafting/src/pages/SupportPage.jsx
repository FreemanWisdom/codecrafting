...
const SupportPage = () => {
    ...
    const activeSupportBg = siteContent.contact_bg || supportBg;
    ...
    return (
        <div className="page-enter">
            <SEO 
                title="Support" 
                description="Get technical support for your projects or inquire about our services. CodingGroups is here to assist you."
                url="/support"
            />
            <PageHero
                badge="Help Desk"
                ...
                backgroundImage={activeSupportBg}
            />
                    ...
                    <div className="max-w-6xl mx-auto">
                        <div className="grid lg:grid-cols-5 gap-16 lg:gap-24">
                            ...
                            <div className="lg:col-span-2">
                                <Reveal>
                                    <p className="text-sm font-bold text-primary-orange uppercase tracking-widest mb-3">Support Channels</p>
                                    <h2 className="text-3xl lg:text-5xl font-heading font-extrabold text-primary-navy mb-10 tracking-tighter leading-tight">
