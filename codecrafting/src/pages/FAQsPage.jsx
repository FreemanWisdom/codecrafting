...
const faqData = [
    ...
    },
    {
        ...
        answer: "CodingGroups Education is designed for anyone serious about mastering frontend development. Whether you're starting out or looking to upgrade to enterprise-level practices, our project-based approach will move the needle."
    },
    {
...
const FAQsPage = () => {
    ...
    const activeFaqsBg = siteContent.faqs_bg || faqsBg;
    ...
    return (
        <div className="page-enter">
            <SEO 
                title="FAQs" 
                description="Find answers to frequently asked questions about our web development process, project timelines, and our educational platform."
                url="/faqs"
            />
            <PageHero
                badge="Knowledge Hub"
                    ...
                    <Reveal>
                        <div className="text-center max-w-2xl mx-auto py-10">
                            ...
                            <div className="flex flex-col sm:flex-row gap-5 justify-center">
                                <Button variant="primary" to="/contact" className="px-10 py-4">Contact Us</Button>
