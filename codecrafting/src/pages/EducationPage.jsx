...
import { Settings02Icon, RocketIcon, MentorIcon, Diamond01Icon, Tick01Icon, Tick02Icon, BrowserIcon } from '@hugeicons/core-free-icons';
...
const EducationPage = () => {
    ...
    const activeEducationBg = siteContent.learn_bg || educationBg;
    ...
    return (
        <div className="page-enter">
            <SEO 
                title="Education" 
                description="Master practical web engineering with CodingGroups Education. Learn to build production-ready digital assets from scratch."
                url="/education"
            />
            <PageHero
                ...
                backgroundImage={activeEducationBg}
            />
                    ...
                    <Reveal>
                        <div className="max-w-4xl mx-auto">
                            <div className="text-center mb-20">
                                <p className="text-sm font-bold text-primary-orange uppercase tracking-widest mb-3">Our Philosophy</p>
                                <h2 className="text-3xl lg:text-6xl font-heading font-extrabold text-primary-navy mb-8 tracking-tighter leading-tight">
                                ...
                                <p className="text-xl text-mid-slate max-w-3xl mx-auto leading-relaxed">
                                    CodingGroups Education is a skill-development platform designed for those who want to master real-world frontend development through hands-on practice and expert mentorship.
                                </p>
                            </div>
                            ...
                            <div className="grid sm:grid-cols-2 gap-8 lg:gap-12">
                                {[
                                    ...
                                    },
                                    {
                                        ...
                                        icon: <HugeiconsIcon icon={MentorIcon} size={40} className="text-primary-orange" />
                                    },
                                    {
                    ...
                    <Reveal>
                        <div className="max-w-3xl mx-auto text-center">
                            <div className="p-10 bg-white shadow-xl rounded-3xl border border-primary-orange/20 relative overflow-hidden">
                                ...
                                <h2 className="text-2xl font-heading font-extrabold text-primary-navy mb-6 tracking-tighter">A Note on Certification</h2>
                                <p className="text-lg text-mid-slate leading-relaxed mb-8">
                                    ...
                                    CodingGroups is a skill-development hub, not an academic institution. We do not provide certificates or formal qualifications. We provide the skills you need to build, deploy, and succeed.
                                </p>
                            ...
                            {submitted ? (
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6 text-left bg-white/5 p-8 lg:p-12 rounded-[40px] border border-white/10 backdrop-blur-md shadow-2xl">
                                    ...
                                    >
                                        {isSubmitting ? (
                                            <>
                                                <HugeiconsIcon icon={BrowserIcon} className="animate-spin h-6 w-6" size={24} />
                                                Processing...
                                            </>
                                        ) : (
