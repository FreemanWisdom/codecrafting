...
const LegalPage = () => {
    ...
    const activeLegalBg = siteContent.legal_bg || legalBg;

    const sections = [
        {
            title: "Privacy Policy",
            content: [
                "Your privacy is critically important to us. At CodingGroups, we have a few fundamental principles: We don't ask you for personal information unless we truly need it. We don't share your personal information with anyone except to comply with the law, develop our products, or protect our rights.",
        ...
        },
        {
            ...
            content: [
                "By using the CodingGroups website and services, you agree to comply with and be bound by the following terms. All content provided on this site is for informational purposes related to our studio services and educational offerings.",
                ...
                "Access to the CodingGroups learning platform (upon launch) will be subject to specific usage terms that will be provided at the time of registration."
            ]
        },
        {
            title: "Disclaimer",
            content: [
                "CodingGroups Education is a skill-development platform focused on practical frontend engineering. We are not an accredited academic institution and do not provide formal certifications or recognized degrees.",
    ...
    return (
        <div className="page-enter">
            <SEO 
                title="Legal" 
                description="Legal information, privacy policy, and terms of service for CodingGroups."
                url="/legal"
            />
            <PageHero
                badge="Governance"
                    ...
                    <Reveal>
                        <div className="text-center py-10">
                            <p className="text-mid-slate text-sm max-w-2xl mx-auto mb-4">
                                These terms were last updated on February 12, 2026. CodingGroups reserves the right to modify these terms as needed to remain compliant with evolving digital standards.
                            </p>
