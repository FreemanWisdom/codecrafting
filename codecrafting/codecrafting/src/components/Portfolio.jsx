...
const ProjectModal = ({ project, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 lg:p-12 fade-in">
            ...
            <div className="relative bg-white rounded-2xl max-w-5xl w-full overflow-hidden shadow-2xl slide-up">
                <button
                    onClick={onClose}
                    className="absolute top-6 right-6 p-2 rounded-full bg-soft-blue/20 text-primary-navy hover:bg-soft-blue/40 transition-colors z-10"
                >
                ...
                <div className="flex flex-col lg:flex-row h-full">
                    ...
                    <div className="lg:w-1/3 p-10 flex flex-col justify-center">
                        <span className="text-xs font-bold text-primary-blue uppercase tracking-widest mb-2">{project.category}</span>
                        <h3 className="text-xl font-heading text-primary-navy mb-6 tracking-tighter">{project.title}</h3>

                        <div className="p-6 bg-soft-blue/30 border border-primary-blue/10 rounded-xl mb-8">
            ...
            <Container>
                <ScrollReveal>
                    <div className="text-center mb-16">
                        <h2 className="text-sm font-bold text-primary-blue uppercase tracking-widest mb-3">Our Work</h2>
                        <h3 className="text-xl lg:text-2xl font-heading text-primary-navy mb-6 tracking-tighter">
                        ...
                        <ScrollReveal key={index} delay={index * 0.1}>
                            <div className="group cursor-pointer" onClick={() => setSelectedProject(project)}>
                                ...
                                <div className="mt-6 flex justify-between items-end">
                                    <div>
                                        <span className="text-xs font-bold text-primary-blue uppercase tracking-widest">{project.category}</span>
                                        <h4 className="text-sm font-heading text-primary-navy mt-2 tracking-tighter">{project.title}</h4>
                                    </div>
                                    <button className="text-sm font-medium text-primary-blue hover:underline">View Details →</button>
                                </div>
                            </div>
                        </ScrollReveal>
                    ))}
