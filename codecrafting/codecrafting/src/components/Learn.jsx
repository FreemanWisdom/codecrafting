                ...
                <ScrollReveal>
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="lg:w-1/2">
                            <div className="inline-block px-4 py-1 bg-primary-blue text-white text-xs font-bold uppercase tracking-widest rounded-full mb-6">
                                Education
                            </div>
                            <h2 className="text-xl lg:text-2xl font-heading text-primary-navy mb-10 tracking-tighter leading-relaxed">
                            ...
                            <div className="space-y-4 mb-10">
                                <div className="flex items-start gap-4">
                                    <div className="mt-1 w-5 h-5 text-primary-blue shrink-0">
                            ...
                            <div className="p-6 bg-white border border-primary-blue/20 rounded-xl">
                                <span className="text-sm font-bold text-primary-blue block mb-2">Coming Soon</span>
                        ...
                        <div className="lg:w-1/2">
                            <div className="grid grid-cols-2 gap-4">
                                <img src={learn1} alt="Learning web development" className="rounded-xl shadow-lg w-full h-64 object-cover" />
                                <img src={learn2} alt="Code editor" className="rounded-xl shadow-lg w-full h-64 object-cover mt-8" />
                                <div className="col-span-2">
                                    <img src={learn3} alt="Web project" className="rounded-xl shadow-lg w-full h-64 object-cover" />
                                </div>
                            </div>
                        </div>
                    </div>
